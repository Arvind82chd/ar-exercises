...
@store2.employees.create(first_name: "Balram", last_name: "Irani", hourly_rate: 70)
@store1.employees.create(first_name: "Ram", last_name: "Rani", hourly_rate: 80)
@store2.employees.create(first_name: "Ali", last_name: "Akbar", hourly_rate: 90)
